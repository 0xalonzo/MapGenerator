...
public class WalkerGenerator : MonoBehaviour
{
    ...
    // pause between each successful movement
    ...
    void Update()
    {
        // check for the 'R' key press to refresh the map
    ...
    void InitializeGrid() {
        ...
        // makes sure its using int instead of float for exact placement
        Vector3Int TileCenter = new Vector3Int(gridHandler.GetLength(0) / 2, gridHandler.GetLength(1) / 2, 0);

        // create new walker and use constructor to set values
    ...
    void RefreshMap() {
        ...
        // re-initialize the grid, generation
        InitializeGrid();
    }
}
